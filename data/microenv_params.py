...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        self.Chemical_A_initial_condition = FloatText(value=0.0,style=style, layout=widget_layout)
        ...
        row5 = [param_name5, self.Chemical_A_diffusion_coefficient, menv_units_button5]
        row6 = [param_name6, self.Chemical_A_decay_rate, menv_units_button6]
        row7 = [param_name7, self.Chemical_A_initial_condition, menv_units_button7]
        row8 = [param_name8, self.Chemical_A_Dirichlet_boundary_condition, menv_units_button8, self.Chemical_A_Dirichlet_boundary_condition_toggle]
